...
class AmityChatRoomWithTextComposeBarFragment() : AmityPickerFragment(),
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            ChatR.layout.amity_fragment_chat_with_text_compose_bar,
            container,
            false
        )
...
//            .subscribe()
    ...
    private fun presentDisconnectedView() {
        if (essentialViewModel.enableConnectionBar) {
            ...
            binding.connectionTexview.setBackgroundColor(resources.getColor(CommonR.color.amityColorGrey))
        }
    }
    ...
    private fun presentChatRefreshLoadingView() {
        binding.loadingView.setBackgroundColor(resources.getColor(CommonR.color.amityTranslucentBackground))
