...
class AmityTextMsgReceiverViewHolder(
    ...
    override fun showPopUp() {
        popUp = AmityPopUp()
        val anchor: View = itemView.findViewById(ChatR.id.tvMessageIncoming)
        ...
        if (itemViewModel.amityMessage?.isFlaggedByMe() == true) {
            binding.reportText.setText(ChatR.string.amity_unreport)
        } else {
            binding.reportText.setText(ChatR.string.amity_report)
        }
